<nav class="navbar navbar-expand-lg navbar-dark bg-gob">
    ...
    <div id="menunavegacion" class="collapse navbar-collapse">
      <ul class="navbar-nav mb-2 mb-lg-2 ms-2 menu text-center flex-fill" data-animation="center">
        ...
        <li class="nav-item"><a class="nav-link" href="#"><div class="p-3 flex-fill bd-highlight">Normatividad y Transparencia</div></a></li>
        <li class="nav-item"><a class="nav-link" href="#"><div class="p-3 flex-fill bd-highlight">Más servicios</div></a></li>
        <li class="nav-item"><a class="nav-link" href="#"><div class="p-3 flex-fill bd-highlight">Galeria</div></a></li>
      </ul>
    </div>
</nav>