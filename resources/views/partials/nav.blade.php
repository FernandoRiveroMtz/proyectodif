<!--  <nav class="navbar navbar-expand-lg navbar-dark bg-gob">0
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item-lg">
            ...
            <hr style="color:white; transform:rotatez(90deg); width:3vw; position:absolute; margin-top: 2%; margin-left:21%;">
