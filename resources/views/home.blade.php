...
<body>
  ...
  <!-- <div class="foot">
  <footer>
  <img src="{{ asset('img/funo.jpg')}}"  class="fotopie" width="200px">
  <div class="footd">
    <h2>o</h2>
  </div>
  </footer>
  ...
  <footer class="bg-white text-center text-black">
    ...
    <div class="container p-4 pb-0">
      ...
      <section class="mb-4">
        ...
        <!-- Instagram -->
        <a class="btn btn-outline-primary btn-floating m-1" href="#!" role="button"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-instagram" viewBox="0 0 16 16">
