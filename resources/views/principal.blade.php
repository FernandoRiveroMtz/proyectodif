...
<body>
  ...
  <!-- <form action="">
  <input type="search" name="buscar" aria-label="Buscador" autocomplete="off" required/>
  <button type="reset" aria-label="Limpiar campo"></button>
  <button type="submit" aria-label="Buscar"></button>
</form> -->

  <form action="">
    <input type="search" name="buscador" id="" size="15px">
    <button type="submit">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item-lg">
            <a class="nav-link" href="#">Salud Pública <br> y Servicios Médicos</a>
          </li>

          <li class="nav-item"><a href="#" class="nav-link">Procuraduria Municipal <br>
              de Protección de Niñas, <br>
              Niños y adolecentes</a></li>
          <li class="nav-item"><a class="nav-link" href="#">Servicios <br>
              Educativos</a></li>
          <li class="nav-item"><a class="nav-link" href="#">Nutrición y <br>
              Alimentación</a></li>
          <li class="nav-item"><a class="nav-link" href="#">Adulto<br>
              Mayor</a></li>
          <li class="nav-item"><a class="nav-link" href="#">Bienestar <br>
              Familiar</a></li>
          <li class="nav-item"><a class="nav-link" href="#">Normatividad<br>
              y Transparencia</a></li>
  ...
  <footer class="bg-white text-center text-black">
    ...
    <div class="container p-4 pb-0">
      ...
      <section class="mb-4">
        ...
        <!-- Twitter -->
        <a class="btn btn-outline-primary btn-floating m-1" href="#!" role="button"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-twitter" viewBox="0 0 16 16">
        ...
        <!-- Instagram -->
        <a class="btn btn-outline-dark btn-floating m-1" href="#!" role="button"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-instagram" viewBox="0 0 16 16">
        ...
        <!-- Linkedin -->
        <a class="btn btn-outline-dark btn-floating m-1" href="#!" role="button"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-tiktok" viewBox="0 0 16 16">
            <path d="M9 0h1.98c.144.715.54 1.617 1.235 2.512C12.895 3.389 13.797 4 15 4v2c-1.753 0-3.07-.814-4-1.829V11a5 5 0 1 1-5-5v2a3 3 0 1 0 3 3V0Z" />
          </svg><i class="fab fa-linkedin-in"></i></a>

        <!-- Github -->
        <a class="btn btn-outline-danger btn-floating m-1" href="#!" role="button"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-youtube" viewBox="0 0 16 16">
